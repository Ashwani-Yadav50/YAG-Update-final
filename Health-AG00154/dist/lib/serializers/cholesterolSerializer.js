...
function transform() {
  return {
    serialize: (() => {
      var _ref = _asyncToGenerator(function* (cholesterolDocument) {
        return yield new Transformer.Serializer('Cholesterol', {
    ...
    deserialize: (() => {
      var _ref2 = _asyncToGenerator(function* (cholesterolDocument) {
        return yield new Transformer.Deserializer({ keyForAttribute: 'camelCase' }).deserialize(cholesterolDocument);

...
function transform() {
  return {
    serialize: (() => {
      var _ref = _asyncToGenerator(function* (spo2Document) {
        return yield new Transformer.Serializer('spo2', {
    ...
    deserialize: (() => {
      var _ref2 = _asyncToGenerator(function* (spo2Document) {
        return yield new Transformer.Deserializer({ keyForAttribute: 'camelCase' }).deserialize(spo2Document);

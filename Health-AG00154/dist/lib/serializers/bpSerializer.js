...
function transform() {
  return {
    serialize: (() => {
      var _ref = _asyncToGenerator(function* (bpDocument) {
        return yield new Transformer.Serializer('BP', {
    ...
    deserialize: (() => {
      var _ref2 = _asyncToGenerator(function* (bpDocument) {
        return yield new Transformer.Deserializer({ keyForAttribute: 'camelCase' }).deserialize(bpDocument);

...
function transform() {
  return {
    serialize: (() => {
      var _ref = _asyncToGenerator(function* (healthDocument) {
        return yield new Transformer.Serializer('health', {
    ...
    deserialize: (() => {
      var _ref2 = _asyncToGenerator(function* (healthDocument) {
        return yield new Transformer.Deserializer({ keyForAttribute: 'camelCase' }).deserialize(healthDocument);

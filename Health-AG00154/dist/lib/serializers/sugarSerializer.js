...
function transform() {
  return {
    serialize: (() => {
      var _ref = _asyncToGenerator(function* (sugarDocument) {
        return yield new Transformer.Serializer('sugar', {
    ...
    deserialize: (() => {
      var _ref2 = _asyncToGenerator(function* (sugarDocument) {
        return yield new Transformer.Deserializer({ keyForAttribute: 'camelCase' }).deserialize(sugarDocument);
